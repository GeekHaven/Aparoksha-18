...
<head>
  ...
  <title>Aparoksha Registrations: Check Your Status</title>
...
<body id="page-top" data-spy="scroll" data-target=".side-menu">
      ...
      <div class="container">
        ...
        <div class="col-md-12 contact-form">
            <h2 class="content-ct" style="font-weight:bold; margin-bottom:1em;"><span class="ti-email"></span> Check Your status here</h2>
            ...
            <form class="form-horizontal" data-toggle="validator" action="check-status.php" role="form" method="post" name="f">
              ...
              <div class="form-group">
                <div class="col-sm-12" style="text-align:center; margin-top:1em;">
                  <button type="submit" id="submit" name="sub1" class="btn btn-yellow">Submit<i class="fa fa-paper-plane" aria-hidden="true" style="padding-left:0.6em;"></i></button>
                </div>
              </div>
            </form>
          </div>
 ...
 <div class="container-fluid" style="<?php if(isset($_SESSION['name'])){echo("display:block;");} else {echo("display:none;");} ?>">
    <table class="table table-sm " style="width:80%; margin-left:auto; margin-right:auto;">
        <tbody>
            <tr>
                <th scope="row" align="center">Name</th>
                <td align="center"><?php if(isset($_SESSION['name'])){echo("{$_SESSION['name']}"); unset($_SESSION['name']);} ?></td>
            </tr>
            <tr>
                <th scope="row" align="center">E-mail</th>
                <td align="center"> <?php if(isset($_SESSION['email'])){echo("{$_SESSION['email']} "); unset($_SESSION['email']);}
