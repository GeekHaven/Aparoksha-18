	...
	public function init()
	{
		if($this -> isLogin == 1 && $this -> place_order == 1)
		{
			...
			if(isset($_POST['saveorder']))
			{
				...
				$this -> hostel  = $_POST['hostel'];
				$this -> contact = $_POST['contact'];	
				$this -> tshirt_type = $_POST['tshirt_type'];
	
				Content::AddOrder($_SESSION['UserId'], $this -> quantity, $this -> size, $this -> gender, $this -> hostel, $this -> contact, $this -> tshirt_type);
