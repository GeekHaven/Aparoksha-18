...
define('SITE_ROOT',$_SERVER['DOCUMENT_ROOT'] . '/poll');
...
define('LOG_ERROR_FILE', '/var/www/websites/aparoksha/poll/error_log.txt');
...
define('DB_USERNAME', 'tech');
define('DB_PASSWORD', 'tech@123');
define('DB_DATABASE', 'tech');
