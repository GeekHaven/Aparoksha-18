...
function sendAccountConfMail($username)
{
	...
	<body>
		Hi {$username},<br> 
		This is a confirmation mail for IIIT-Allahabad Aparoksha user account. <br>
		Please click the following link to validate your account. <br><br> 
		<a href='{$url}' >Click to Confirm.</a><br><br>

		Thank You for connecting with Aparoksha 2015.<br><br><br>
...
function sendMail( $subscriberEmail, $subject, $body) 
{
	...
	$mail->FromName = "Aparoksha IIITA";    //From Name -- CHANGE --^M
