...
//ftp credentials for dir creation and file writing	
	...
	define('8_eve', "/register/event/perplexus/");
	define('4_eve', "/register/event/infinitum/");
	define('10_eve', "/register/event/itquiz/");
	define('11_eve', "/register/event/technobooz/");
	define('14_eve', "/register/event/platzen/");
	define('15_eve', "/register/event/coldfire/");
	define('20_eve', "/register/event/blackbox/");
