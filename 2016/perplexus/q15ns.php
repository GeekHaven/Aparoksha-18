...
if($score!=140 && $qs_ans!=14)
{
  header("Location: play.php");
}


$ques=mysql_query("SELECT * FROM ques WHERE ques_id=15");
...
if(isset($_POST['q15_submit']))
{
	...
	{
		$q15_score=10;
		if(mysql_query("UPDATE users SET score=150,qs_ans=15 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q01045.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q15_ans" name="q15_ans" type="text" class="validate white-text">
          <label for="q15_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q15_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
