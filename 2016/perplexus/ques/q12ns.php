...
if(isset($_POST['q12_submit']))
{
	...
	{
		$q12_score=10;
		if(mysql_query("UPDATE users SET q12=10 , score=score+10 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
    ...
    <form method="post" class="col s12">
      <div class="row">
        <div class="input-field col s12 m3">
          <input placeholder="Enter text" id="q12_ans" name="q12_ans" type="text" class="validate">
          <label for="q12_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large" type="submit" name="q12_submit">Submit
