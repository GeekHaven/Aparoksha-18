...
if(isset($_POST['q1_submit']))
{
	...
	{
		$q1_score=10;
		if(mysql_query("UPDATE users SET q1=10 , score=score+10 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<body>
 ...
 <button class="btn waves-effect waves-light btn-large" type="submit" name="q1_submit">Submit
