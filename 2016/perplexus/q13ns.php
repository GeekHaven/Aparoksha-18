...
if($score!=120 && $qs_ans!=12)
{
  header("Location: play.php");
}


$ques=mysql_query("SELECT * FROM ques WHERE ques_id=13");
...
if(isset($_POST['q13_submit']))
{
	...
	if($q13_ans==$q13 || $q13_ans== '1b0e519522c7b8dcf7ecb030c0688bb17')
	{
		$q13_score=10;
		if(mysql_query("UPDATE users SET score=130,qs_ans=13 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q11346.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q13_ans" name="q13_ans" type="text" class="validate white-text">
          <label for="q13_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q13_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
