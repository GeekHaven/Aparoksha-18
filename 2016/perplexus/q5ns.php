...
if($score!=40 && $qs_ans!=4)
{
  header("Location: play.php");
}


$ques=mysql_query("SELECT * FROM ques WHERE ques_id=5");
...
if(isset($_POST['q5_submit']))
{
	...
	{
		$q5_score=10;
		if(mysql_query("UPDATE users SET score=50,qs_ans=5 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q37600.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q5_ans" name="q5_ans" type="text" class="validate white-text">
          <label for="q5_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q5_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
