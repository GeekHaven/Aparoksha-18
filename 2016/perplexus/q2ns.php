...
if(isset($_POST['q2_submit']))
{
	$q2_ans = mysql_real_escape_string($_POST['q2_ans']);
	$q2_ans=trim($q2_ans);
	$q2_ans=md5($q2_ans);
	$q2_ans=trim($q2_ans);
	...
	{
		$q2_score=10;
		if(mysql_query("UPDATE users SET score=20,qs_ans=2 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q59225.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12">
      <div class="row">
        <div class="input-field col s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q2_ans" name="q2_ans" type="text" class="validate white-text">
          <label for="q2_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q2_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
