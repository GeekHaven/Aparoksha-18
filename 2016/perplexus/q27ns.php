...
if($score!=260 && $qs_ans!=26)
{
  header("Location: play.php");
}


$ques=mysql_query("SELECT * FROM ques WHERE ques_id=27");
...
if(isset($_POST['q27_submit']))
{
	...
	{
		$q27_score=10;
		if(mysql_query("UPDATE users SET score=270,qs_ans=27 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q79200.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row" id = "ii">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q27_ans" name="q27_ans" type="text" class="validate white-text">
          <label for="q27_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q27_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
