...
if($score!=190 && $qs_ans!=19)
{
  header("Location: play.php");
}

$ques=mysql_query("SELECT * FROM ques WHERE ques_id=20");
...
if(isset($_POST['q20_submit']))
{
	...
	if($q20_ans==$q20)
	{
		...
		if(mysql_query("UPDATE users SET score=200,qs_ans=20 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q66109.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q20_ans" name="q20_ans" type="text" class="validate white-text">
          <label for="q20_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q20_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
