...
if($score!=160 && $qs_ans!=16)
{
  header("Location: play.php");
}


$ques=mysql_query("SELECT * FROM ques WHERE ques_id=17");
...
if(isset($_POST['q17_submit']))
{
	...
	if($q17_ans==$q17)
	{
		...
		if(mysql_query("UPDATE users SET score=170,qs_ans=17 WHERE user_id=".$_SESSION['user']))
    		{
      			?>
...
<header>
  ...
  <div id="test1" class="col s12 m9"><br>
        ...
        <img id = "mainimg" class="materialboxed initialized" height="400" width="650" src="images/q33711.jpg" ><br>
	       
	<div class="row">
    <form method="post" class="col s12 ">
      <div class="row">
        <div class="input-field  col  s12 m6" id = "mainfield">
          <input placeholder="Enter text" id="q17_ans" name="q17_ans" type="text" class="validate white-text">
          <label for="q17_ans">Answer</label>
        </div>
 <button class="btn waves-effect waves-light btn-large black" type="submit" name="q17_submit" id ="mainbutton" ><i class="material-icons right">send</i>
  </button>
  </div>
    </form>
  </div></div>
