...
<body id="page-top" class="index" style="overflow:hidden;">
	...
	<section >
		<div class="container">
            <div class="row">
				<ul style="font-size: 1.5em;font-weight: bold; color: #CAE8E7; background-color: rgba(26, 99, 107, 0.65);border-radius: 20px;padding-top: 2%; padding-bottom:2%;">
					<li>Aniket Mukherjee -  9476224760</li>
