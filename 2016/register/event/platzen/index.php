    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="padding:0px;background-color: rgba(58, 155, 165, 0.33);">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand active" href="#">Platzen</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" >
                    ...
                    <li class="page-scroll">
                        <a href="https://www.facebook.com/platzen15">Hints</a>
                    </li>
                    <?php if($islogin && $isvalid) {
						$_SESSION['log'] = 1;
					  	echo '<li class="page-scroll"><a href="http://aparoksha.iiita.ac.in/register/models/logout.php">Logout</a></li>';
					  }?>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
		...
		<section id="contact" >
        	<div class="container"><div class="row"  style="text-align:center;padding:2% 0%;color: #CAE8E7;background-color: rgba(26, 99, 107, 0.65);border-radius: 20px;">
                <div class="col-lg-12">
                	<?php if($islogin && $isvalid) { 
								if($fl) {?>
                    ...
                    <?php } else {
							...
							echo '<span style="text-align:center;">You must login to start the quiz.<br><br><form action="https://effervescence.iiita.ac.in/register/?page=login" method="POST"><input type="hidden" name="q" value="2"/><input type="submit"  value="Login"  class="btn btn-default"></form></span>';
						} else {
