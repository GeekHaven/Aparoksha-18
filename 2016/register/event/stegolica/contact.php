...
<body id="page-top" class="index" style="overflow:hidden;">
	...
	<section>
		<div class="container">
            <div class="row">
				<ul style="font-size: 1.5em;font-weight: bold; color: #CAE8E7;padding-bottom:2%;background: linear-gradient(#0A0A0A 55%, rgba(21, 79, 69, 0.43));border-radius: 20px;padding-top: 2%;">
					<li>Saptak Sengupta - 8953346034</li>
