...
<body id="page-top" class="index" >
	...
	<section>
		<div class="container">
            <div class="row"  style="text-align:center;color: #CAE8E7;padding-bottom:2%;background: linear-gradient(#0A0A0A 55%, rgba(21, 79, 69, 0.43));border-radius: 20px;padding-top: 2%;">
                <!--
