    ...
    box-shadow: #DADDE0 1px 1px 10px;">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand active" href="#">Stegolica(Event Has Ended....)</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="https://www.facebook.com/stegolica">Hints</a>
                    </li>
		...
		<section id="contact" style="/*font-size:12px;*/">
        	<div class="container"><div class="row"  style="text-align:center;color: #CAE8E7;padding-bottom:2%;background: linear-gradient(#0A0A0A 55%, rgba(21, 79, 69, 0.43));border-radius: 20px;padding-top: 2%;">
                <div class="col-lg-12">
                	<?php if($islogin && $isvalid) { 
								if($fl) {?>
							<center><h3 style = "padding-top: 0px;padding-bottom: 25px;">Question - <?php echo $qno ?></h3></center>
                    <div class="row" style="padding-bottom:20px;">
                        <!--<img src="img/bg.jpg" style="width:41.5%;"/>-->
                        <h4>Find the required files here:</h4>
					...
					<form name="form-control" method="POST" action="index.php">						
						<div class="row control-group">
                            <div class="form-group col-lg-12 floating-label-form-group controls">
                                ...
                                <input style="color:white;" type="text" name="ans" class="form-control" placeholder="enter your answer" id="cpwd" required data-validation-required-message="Please enter your answer">
							</div>
                        </div>
                        <br>
                        <div class="row">
                    ...
                    <?php } else {
							...
							echo '<span style="text-align:center;">You must login to start the quiz.<br><br><form action="https://effervescence.iiita.ac.in/register/?page=login" method="POST"><input type="hidden" name="q" value="3"/><input type="submit"  value="Login"  class="btn btn-default"></form></span>';
						} else {
