...
if(isset($_GET['nav'])) {
 ...
 <!-- Main Nav -->
    <div class="side">
      <ul id="sidetext">
        <li><a class="opt" href="?nav=dashboard" <?php if ($active == 'dashboard') echo "class='active'"; ?> ><span>Dashboard</span></a></li>
        <li><a class="opt" href="?nav=registration" <?php if ($active == 'registration') echo "class='active'"; ?> ><span>Event Catalogue</span></a></li>
        ...
        <li><a class="opt" href="?nav=profile" <?php if ($active == 'profile'  ||  $active=='') echo "class='active'"; ?> ><span>My Profile</span></a></li>
      </ul>
    </div>
    <!-- End Main Nav -->
