...
function mailsend($email,$hash, $name){
    ...
    try {
        ...
        $mail->Body    = 'Greetings!<br><br>Thanks for registering for Humblefoolcup 2018, We have received
                            your participation request, however your registration is incomplete until you activate your account.
                            Kindly click on the following link to activate your account <br><br>
                            https://aparoksha.org/humblefoolcup/register/approve.php?email='.$email.'&activate='.$hash.'<br><br> 
