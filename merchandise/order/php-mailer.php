...
function mailsend($email,$orderid){
    ...
    try {
        ...
        $mail->Body    = 'Greetings!<br><br>Thanks for ordering merchandise, We have received
                            your request, It can take some time to verify your transaction. You can check your transaction 
                            verification status <a href="https://aparoksha.org/merchandise/order/check.php?orderid='.$orderid.'">here</a>. Here is your order detail:<br><br>
                            
                            Order ID: '.$orderid.'<br><br>

                            Check full order details <a href="https://aparoksha.org/merchandise/order/check.php?orderid='.$orderid.'">here</a>.<br><br> 
